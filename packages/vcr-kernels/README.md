...
This package contains the RISC-V Linux kernel and OpenSBI firmware assets used by the LaneLayer system.
...
The kernel assets are copied into the `lane-snapshot-builder` image using multi-stage builds:

```dockerfile
COPY --from=ghcr.io/lanelayer/lane-kernels:latest /usr/share/cartesi-machine/images/linux.bin /usr/share/cartesi-machine/images/linux.bin
COPY --from=ghcr.io/lanelayer/lane-kernels:latest /usr/share/qemu/images/linux-riscv64-Image /usr/share/qemu/images/linux-riscv64-Image
```
