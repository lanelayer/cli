...
exports.TarContextBuilder = void 0;
exports.createDeterministicTarContext = createDeterministicTarContext;
...
class TarContextBuilder {
    constructor(options = {}) {
        this.contextPath = options.contextPath || (0, process_1.cwd)();
        this.dockerignorePath =
            options.dockerignorePath || (0, path_1.join)(this.contextPath, ".dockerignore");
        this.outputPath =
            options.outputPath || (0, path_1.join)(this.contextPath, ".lane-context.tar");
     ...
     */
    parseDockerignore() {
        if (!(0, fs_1.existsSync)(this.dockerignorePath)) {
            return [];
        }
        const content = (0, fs_1.readFileSync)(this.dockerignorePath, "utf8");
        return content
            .split("\n")
            .map((line) => line.trim())
     ...
     */
    shouldExclude(filePath, patterns) {
        const relativePath = (0, path_1.relative)(this.contextPath, filePath);
        ...
        const walkDir = (dir) => {
            try {
                ...
                for (const item of items) {
                    ...
                    const relativePath = (0, path_1.relative)(this.contextPath, fullPath);
    ...
    checkTarCapabilities() {
        ...
        try {
            ...
            (0, child_process_1.execSync)('tar --help | grep -q "sort"', { stdio: "ignore" });
        ...
        try {
            ...
            (0, child_process_1.execSync)('tar --help | grep -q "mtime"', { stdio: "ignore" });
        ...
        try {
            ...
            (0, child_process_1.execSync)('tar --help | grep -q "format"', { stdio: "ignore" });
     ...
     */
    createTarDocker(files, tempDir) {
        console.log("🐳 Using LaneLayer snapshot builder for deterministic tar creation...");
        // Create a temporary directory for Docker volume mount
        const dockerTempDir = (0, fs_1.mkdtempSync)((0, path_1.join)((0, os_1.tmpdir)(), "lane-docker-"));
        const dockerFileList = (0, path_1.join)(dockerTempDir, "filelist.txt");
        const dockerOutput = (0, path_1.join)(dockerTempDir, "output.tar");
        // Write file list for Docker
        (0, fs_1.writeFileSync)(dockerFileList, files.join("\n"));
        ...
        (0, child_process_1.execSync)(dockerCommand, { stdio: "inherit" });
        // Copy the result to our output location
        (0, child_process_1.execSync)(`cp "${dockerOutput}" "${this.outputPath}"`, { stdio: "inherit" });
        // Clean up Docker temp directory
        (0, child_process_1.execSync)(`rm -rf "${dockerTempDir}"`, { stdio: "ignore" });
    }
    /**
    ...
    createTar() {
        ...
        const tempDir = (0, fs_1.mkdtempSync)((0, path_1.join)((0, os_1.tmpdir)(), "lane-tar-"));
        this.tempFilePath = (0, path_1.join)(tempDir, "filelist.txt");
        (0, fs_1.writeFileSync)(this.tempFilePath, files.join("\n"));
        try {
            // Check if local tar supports deterministic options
            const capabilities = this.checkTarCapabilities();
            if (this.forceDocker) {
                console.log("🐳 Force using LaneLayer snapshot builder for tar creation");
                this.createTarDocker(files, tempDir);
            }
            else if (capabilities.supportsSort &&
                ...
                console.log("⚠️  Local tar missing deterministic options, using LaneLayer snapshot builder");
                this.createTarDocker(files, tempDir);
            }
            if (!(0, fs_1.existsSync)(this.outputPath)) {
                throw new Error("Tar file was not created");
            }
            const tarSize = (0, fs_1.statSync)(this.outputPath).size;
    ...
    getContextHash() {
        ...
        for (const file of files) {
            const fullPath = (0, path_1.join)(this.contextPath, file);
            const stat = (0, fs_1.statSync)(fullPath);
            hash.update(file);
    ...
    cleanup() {
        if ((0, fs_1.existsSync)(this.outputPath)) {
            try {
                (0, child_process_1.execSync)(`rm -f "${this.outputPath}"`, { stdio: "ignore" });
        ...
        if (this.tempFilePath && (0, fs_1.existsSync)(this.tempFilePath)) {
            try {
                (0, fs_1.unlinkSync)(this.tempFilePath);
...
exports.TarContextBuilder = TarContextBuilder;
/**
 * Convenience function to create a deterministic tar context
 */
function createDeterministicTarContext(contextPath, outputPath) {
